...
const _prepareParams = (inputStyle, index) => {
  ...
  const style = (0, _defaults.default)({}, lineStyle, defaultStyle);
...
const _getMeasurementContainer = (0, _memoize.default)(() => {
...
const _measureDimensionsInternal = (0, _memoize.default)((text, style) => {
