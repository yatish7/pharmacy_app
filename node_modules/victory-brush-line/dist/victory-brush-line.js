...
class VictoryBrushLine extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  static defaultProps = {
    allowDrag: true,
    allowDraw: true,
    allowResize: true,
    brushAreaComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__.Border, null),
    brushComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__.Border, null),
    groupComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("g", null),
    handleComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_8__.Border, null),
    handleWidth: 10,
    lineComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_9__.LineSegment, null),
    width: 10
  };
  ...
  renderHandles(props) {
    ...
    return [/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(handleComponent, minHandleProps), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(handleComponent, maxHandleProps)];
  }
  renderBrush(props) {
    const {
      brushComponent,
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(brushComponent, brushProps);
  }
  renderBrushArea(props) {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(brushAreaComponent, brushAreaProps);
  }
  renderLine(props) {
    const filteredProps = lodash_pick__WEBPACK_IMPORTED_MODULE_2___default()(props, ["x1", "x2", "y1", "y2", "datum", "scale", "active", "style"]);
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(props.lineComponent, filteredProps);
  }
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("g", this.props.events, this.renderLine(this.props), this.renderBrushArea(this.props), this.renderBrush(this.props), this.renderHandles(this.props));
  }
}
