...
class VictoryBrushLine extends _react.default.Component {
      ...
      eventHandlers: {
        ...
        onMouseUp: (evt, targetProps) => {
          ...
          if (allowResize && _victoryCore.Helpers.isFunction(onBrushDomainChange)) {
            onBrushDomainChange(brushDomain, (0, _defaults.default)({}, mutatedProps, targetProps));
          }
          return [{
            mutation: () => mutatedProps
          }];
  ...
  renderLine(props) {
    const filteredProps = (0, _pick.default)(props, ["x1", "x2", "y1", "y2", "datum", "scale", "active", "style"]);
