...
class VictorySharedEvents extends _react.default.Component {
  ...
  getExternalMutations(props, baseProps) {
    return !(0, _isEmpty.default)(props.externalEventMutations) ? _victoryCore.Events.getExternalMutationsWithChildren(props.externalEventMutations, baseProps, this.state, Object.keys(baseProps)) : undefined;
  }
  ...
  getBasePropsFromChildren(childComponents) {
    ...
    return (0, _fromPairs.default)(baseProps);
  }
  ...
  getContainer(props, baseProps, events) {
    ...
    const parentProps = (0, _defaults.default)({}, this.getEventState("parent", "parent"), containerProps, baseProps.parent, {
      children
    });
    const containerEvents = (0, _defaults.default)({}, _victoryCore.Events.getPartialEvents(parentEvents, "parent", parentProps), containerProps.events);
