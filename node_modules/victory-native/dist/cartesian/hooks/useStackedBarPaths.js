    ...
    const paths = react_1.default.useMemo(() => {
        ...
        points.forEach((pointsArray, i) => {
            pointsArray.forEach((point, j) => {
                ...
                if (roundedCorners) {
                    const nonUniformRoundedRect = (0, createRoundedRectPath_1.createRoundedRectPath)(x, y - (offset !== null && offset !== void 0 ? offset : 0), barWidth, barHeight, roundedCorners, Number(yValue));
