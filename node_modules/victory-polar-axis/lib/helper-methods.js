...
const filterTicks = (ticks, scale) => {
  ...
  return (0, _uniqBy.default)(ticks, compareTicks);
};
...
const getStyleObject = props => {
  ...
  const mergeStyles = () => {
    ...
    return styleNamespaces.reduce((memo, curr) => {
      memo[curr] = (0, _defaults.default)({}, specificAxisStyle?.[curr], generalAxisStyle?.[curr]);
      return memo;
    }, {});
  };
...
const getRadius = props => {
  const {
    ...
    top,
    bottom
  } = _victoryCore.Helpers.getPadding(props.padding);
  const {
    width,
    height
  } = props;
...
const getStyles = function (props, styleObject) {
  ...
  return {
    parent: (0, _defaults.default)(parentStyleProps, style.parent, styleObject.parent),
    axis: (0, _defaults.default)({}, style.axis, styleObject.axis),
    axisLabel: (0, _defaults.default)({}, style.axisLabel, styleObject.axisLabel),
    grid: (0, _defaults.default)({}, style.grid, styleObject.grid),
    ticks: (0, _defaults.default)({}, style.ticks, styleObject.ticks),
    tickLabels: (0, _defaults.default)({}, style.tickLabels, styleObject.tickLabels)
  };
};
