...
const Helpers = {
  ...
  getDomainBox(props, fullDomain, selectedDomain) {
    ...
    const fullDomainObject = (0, _defaults.default)({}, fullDomain, props.domain);
    const selectedDomainObject = (0, _defaults.default)({}, selectedDomain, fullDomainObject);
  ...
  panBox(props, point) {
    ...
    const brushDimension = this.getDimension(props);
    const brushDomain = (0, _defaults.default)({}, props.brushDomain, domain);
    const fullDomain = (0, _defaults.default)({}, props.fullDomain, domain);
    const {
      x1,
      x2,
      y1,
  ...
  onMouseDown(evt, targetProps) {
    ...
    const brushDomain = (0, _defaults.default)({}, targetProps.brushDomain, domain);
  ...
  onGlobalMouseMove(evt, targetProps) {
    ...
    if (allowDrag && isPanning) {
      ...
      if (_victoryCore.Helpers.isFunction(onBrushDomainChange)) {
        onBrushDomainChange(currentDomain, (0, _defaults.default)({}, mutatedProps, targetProps));
      }
      return [{
        target: "parent",
  ...
  onGlobalMouseUp(evt, targetProps) {
    ...
    if ((allowResize || defaultBrushHasArea) && (x1 === x2 || y1 === y2)) {
      ...
      if (_victoryCore.Helpers.isFunction(onBrushDomainChange)) {
        onBrushDomainChange(defaultDomain, (0, _defaults.default)({}, mutatedProps, targetProps));
      }
      if (_victoryCore.Helpers.isFunction(onBrushDomainChangeEnd)) {
        onBrushDomainChangeEnd(defaultDomain, (0, _defaults.default)({}, mutatedProps, targetProps));
      }
      if (_victoryCore.Helpers.isFunction(onBrushCleared)) {
        onBrushCleared(defaultDomain, (0, _defaults.default)({}, mutatedProps, targetProps));
      }
    } else if (allowDrag && isPanning || allowResize && isSelecting) {
      if (_victoryCore.Helpers.isFunction(onBrushDomainChangeEnd)) {
        onBrushDomainChangeEnd(currentDomain, (0, _defaults.default)({}, mutatedProps, targetProps));
      }
    }
    return [{
      target: "parent",
...
const BrushHelpers = exports.BrushHelpers = {
  ...
  onGlobalMouseMove: (0, _throttle.default)(Helpers.onGlobalMouseMove.bind(Helpers), 16,
