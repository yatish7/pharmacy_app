...
const checkProcessedData = data => {
  ...
  if (hasQuartileAttributes) {
    ...
    if (!(0, _uniq.default)(values).length === values.length) {
      throw new Error(`
...
const getLabelStyle = (props, styleObject, namespace) => {
  ...
  return (0, _defaults.default)({}, tooltipTheme.style, baseStyle);
};
const getStyles = function (props, styleObject) {
  ...
  const labelStyles = (0, _defaults.default)({}, style.labels, getLabelStyle(props, styleObject));
  const boxStyles = (0, _defaults.default)({}, style.boxes, styleObject.boxes);
  const whiskerStyles = (0, _defaults.default)({}, style.whiskers, styleObject.whiskers);
  return {
    boxes: boxStyles,
    labels: labelStyles,
    parent: (0, _defaults.default)({}, style.parent, styleObject.parent, parentStyles),
    max: (0, _defaults.default)({}, style.max, styleObject.max, whiskerStyles),
    maxLabels: (0, _defaults.default)({}, style.maxLabels, getLabelStyle(props, styleObject, "max"), labelStyles),
    median: (0, _defaults.default)({}, style.median, styleObject.median, whiskerStyles),
    medianLabels: (0, _defaults.default)({}, style.medianLabels, getLabelStyle(props, styleObject, "median"), labelStyles),
    min: (0, _defaults.default)({}, style.min, styleObject.min, whiskerStyles),
    minLabels: (0, _defaults.default)({}, style.minLabels, getLabelStyle(props, styleObject, "min"), labelStyles),
    q1: (0, _defaults.default)({}, style.q1, styleObject.q1, boxStyles),
    q1Labels: (0, _defaults.default)({}, style.q1Labels, getLabelStyle(props, styleObject, "q1"), labelStyles),
    q3: (0, _defaults.default)({}, style.q3, styleObject.q3, boxStyles),
    q3Labels: (0, _defaults.default)({}, style.q3Labels, getLabelStyle(props, styleObject, "q3"), labelStyles),
