...
const getStyles = function (props, style, defaultStyles) {
  ...
  const labelStyle = (0, _defaults.default)({}, style.labels, defaultLabels);
  return {
    parent: (0, _defaults.default)({}, style.parent, defaultParent, {
      width,
      height
    }),
    labels: labelStyle,
    data: (0, _defaults.default)({}, style.data, defaultData),
    openLabels: (0, _defaults.default)({}, style.openLabels, getLabelStyle(props, defaultStyles, "open"), labelStyle),
    closeLabels: (0, _defaults.default)({}, style.closeLabels, getLabelStyle(props, defaultStyles, "close"), labelStyle),
    lowLabels: (0, _defaults.default)({}, style.lowLabels, getLabelStyle(props, defaultStyles, "low"), labelStyle),
    highLabels: (0, _defaults.default)({}, style.highLabels, getLabelStyle(props, defaultStyles, "high"), labelStyle)
  };
};
...
const getOrientation = function (labelOrientation, type) {
  ...
  return (0, _isPlainObject.default)(labelOrientation) ? labelOrientation[type] : labelOrientation;
};
...
const getBaseProps = (initialProps, fallbackProps) => {
  ...
  return data.reduce((childProps, datum, index) => {
    ...
    const extendedProps = (0, _defaults.default)(Object.assign({}, dataProps), props);
    childProps[eventKey] = {
      data: dataProps
    };
    if (labels) {
