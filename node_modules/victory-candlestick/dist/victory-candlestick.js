...
const defaultProps = {
  ...
  lineComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_3__.Line, null),
  rectComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_4__.Rect, null),
  role: "presentation",
  shapeRendering: "auto"
};
const Candle = props => {
  const modifiedProps = evaluateProps(lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, props, defaultProps));
  const {
    ariaLabel,
    events,
    groupComponent,
  ...
  const wickStyle = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(groupComponent, {}, [/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(rectComponent, candleProps), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(lineComponent, highWickProps), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(lineComponent, lowWickProps)]);
};
...
const getStyles = function (props, style, defaultStyles) {
  ...
  const labelStyle = lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, style.labels, defaultLabels);
  return {
    parent: lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, style.parent, defaultParent, {
      width,
      height
    }),
    labels: labelStyle,
    data: lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, style.data, defaultData),
    openLabels: lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, style.openLabels, getLabelStyle(props, defaultStyles, "open"), labelStyle),
    closeLabels: lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, style.closeLabels, getLabelStyle(props, defaultStyles, "close"), labelStyle),
    lowLabels: lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, style.lowLabels, getLabelStyle(props, defaultStyles, "low"), labelStyle),
    highLabels: lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, style.highLabels, getLabelStyle(props, defaultStyles, "high"), labelStyle)
  };
};
...
const getOrientation = function (labelOrientation, type) {
  ...
  return lodash_isPlainObject__WEBPACK_IMPORTED_MODULE_1___default()(labelOrientation) ? labelOrientation[type] : labelOrientation;
};
...
const getLabelProps = (props, text, style, type) => {
  ...
  return lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, labelProps, victory_core__WEBPACK_IMPORTED_MODULE_4__.omit(tooltipTheme, ["style"]));
};
...
const getBaseProps = (initialProps, fallbackProps) => {
  ...
  return data.reduce((childProps, datum, index) => {
    ...
    const extendedProps = lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()(Object.assign({}, dataProps), props);
    childProps[eventKey] = {
      data: dataProps
    };
    if (labels) {
