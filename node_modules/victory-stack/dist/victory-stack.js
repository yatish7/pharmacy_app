...
function getChildProps(props, calculatedProps) {
  ...
  return {
    height: props.height,
    width: props.width,
    padding: victory_core__WEBPACK_IMPORTED_MODULE_4__.getPadding(props.padding),
    standalone: false,
    theme: props.theme,
    categories,
    domain,
...
const VictoryStackBase = initialProps => {
  ...
  const childComponents = react__WEBPACK_IMPORTED_MODULE_0___default().Children.toArray(modifiedProps.children);
  ...
  const userProps = react__WEBPACK_IMPORTED_MODULE_0___default().useMemo(() => victory_core__WEBPACK_IMPORTED_MODULE_9__.getSafeUserProps(propsWithDefaults), [propsWithDefaults]);
  const container = react__WEBPACK_IMPORTED_MODULE_0___default().useMemo(() => {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(groupComponent, userProps);
  ...
  if (!lodash_isEmpty__WEBPACK_IMPORTED_MODULE_2___default()(events)) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(victory_shared_events__WEBPACK_IMPORTED_MODULE_12__.VictorySharedEvents, {
      container: container,
      eventKey: eventKey,
      events: events,
...
const VictoryStack = Object.assign( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().memo(VictoryStackBase, (react_fast_compare__WEBPACK_IMPORTED_MODULE_3___default())), componentConfig);
